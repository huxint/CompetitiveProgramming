/**
 * @brief 各种筛法算法集合
 * @details 包含埃拉托斯特尼筛、最小质因数筛、莫比乌斯函数筛、欧拉函数筛等
 *          支持质数查询、质数判断、质因数分解、欧拉函数和莫比乌斯函数计算
 *          支持查询第k个质数、区间质数个数统计、迭代器访问等功能
 *          EratosthenesSieve用于单纯快速筛质数（因为不需要取模， 运行速度远远快于欧拉筛）, MinPrimeSieve用于质因数分解
 * @author huxint
 */
#pragma once
#include <cmath>
